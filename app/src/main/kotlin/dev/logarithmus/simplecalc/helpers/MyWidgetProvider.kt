...
class MyWidgetProvider : AppWidgetProvider(), Calculator {
    ...
    private fun performUpdate(context: Context) {
        ...
        appWidgetManager.getAppWidgetIds(getComponentName(context)).forEach {
            ...
            setupIntent(context, views, DECIMAL, R.id.btn_dot)
            ...
            setupIntent(context, views, MULTIPLY, R.id.btn_mult)
...
//    }
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (action) {
            DECIMAL, ZERO, ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, EQUALS, CLEAR, RESET, PLUS, MINUS, MULTIPLY, DIVIDE -> myAction(action, context)
    ...
    private fun myAction(action: String, context: Context) {
        ...
        when (action) {
            DECIMAL -> calc!!.numpadClicked(R.id.btn_dot)
            ...
            PLUS, MINUS, MULTIPLY, DIVIDE -> calc!!.handleOperation(action)
        }
    }
